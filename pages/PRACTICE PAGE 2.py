...
from streamlit_echarts import st_echarts  # Import ECharts
...
with tab1:
    ...
    if not merged_df.empty:
        ...
        with col_pie:
            # ECharts Pie Chart for Tasked vs Untasked Orders
            chart_data = [
                {"value": tasked_orders_count, "name": "Tasked Orders"},
                {"value": untasked_orders_count, "name": "Untasked Orders"}
            ]
