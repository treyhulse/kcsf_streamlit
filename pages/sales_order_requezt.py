...
# Input for Sales Order Internal ID
sales_order_id = st.text_input("Enter Sales Order ID", value="")

# Button to fetch sales order data
if st.button("Fetch Sales Order"):
    if sales_order_id:
        ...
        st.error("Please enter a Sales Order ID.")