...
def get_website_revenue_by_month():
    ...
    website_orders = df['Orders'].sum()
    avg_order_volume = total_revenue / website_orders if website_orders > 0 else 0
    ...
    return fig, df_grouped, website_orders, avg_order_volume
